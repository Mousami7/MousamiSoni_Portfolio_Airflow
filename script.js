...
function handleNavbarScroll() {
    if (window.scrollY > 100) {
        ...
        navbar.style.boxShadow = '0 2px 20px rgba(1, 124, 238, 0.4)';
    } else {
        navbar.style.background = 'rgba(10, 22, 40, 0.95)';
        navbar.style.boxShadow = '0 8px 32px rgba(1, 124, 238, 0.3)';
    }
}
...
// Enhanced particle effect for hero section - Airflow inspired
function createParticles() {
    ...
    for (let i = 0; i < particleCount; i++) {
        ...
        const colors = ['#017CEE', '#4A9EFF', '#FF6B35', '#00D4AA'];
...
// Add particle animation to CSS - Airflow inspired
